...
const rawTema14FacilTest = {
  "fileName": "Tema 14 - Fuentes del Derecho (Fácil)",
  "category": "madrid",
  "questions": [
    {
      "id": 1,
...
export const tema14FacilTest: SeedExam = {
    fileName: rawTema14FacilTest.fileName,
    category: rawTema14FacilTest.category,
    questions: rawTema14FacilTest.questions.map(q => {
        return {
