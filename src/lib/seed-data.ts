...
export const estadoConstitutionTest: SeedExam = {
    ...
    questions: [
        ...
        },
        {
            ...
            options: [ "Capítulo II.", "Capítulo V.", "Capítulo I." ],
            correctAnswerIndex: 1,
        ...
        },
        {
            ...
            options: [ "Defensa.", "Urbanismo.", "Justicia." ],
            correctAnswerIndex: 1,
        ...
        },
        {
            ...
            options: [ "El Gobierno.", "El poder judicial.", "La oposición." ],
            correctAnswerIndex: 0,
        ...
        },
        {
            ...
            options: [ "En el Título II.", "En el Título IV.", "En el Título I." ],
            correctAnswerIndex: 2,
        ...
        },
        {
            ...
            options: [ "Decretos legislativos.", "Reglamento.", "Leyes ordinarias." ],
            correctAnswerIndex: 0,
        ...
        },
        {
            ...
            options: [ "Un deber únicamente.", "Un derecho únicamente.", "Un deber y un derecho." ],
            correctAnswerIndex: 2,
        ...
        {
            questionText: "El Ministerio Fiscal ejerce sus funciones por medio de::\\:El Ministerio Fiscal ejerce sus funciones por medio de:",
            options: [
        ...
        },
        {
            ...
            options: [ "Diputación Provincial.", "Cabildo Insular.", "Ayuntamiento." ],
            correctAnswerIndex: 2,
        ...
        },
        {
            ...
            options: [ "Mayoría simple.", "Mayoría absoluta.", "2/3 de los votos." ],
            correctAnswerIndex: 0,
        ...
        },
        {
            ...
            options: [ "Real Decreto.", "Ley Orgánica.", "Ley Ordinaria." ],
            correctAnswerIndex: 1,
        ...
        },
        {
            ...
            options: [ "Motivadas.", "Orales con las excepciones que prevean las leyes de procedimiento.", "Escritas." ],
            correctAnswerIndex: 0,
        ...
        },
        {
            ...
            options: [ "El Título IX.", "El Título X.", "El Título XI." ],
            correctAnswerIndex: 1,
