...
export async function getCategories(): Promise<{ success: boolean, categories?: Category[], error?: string }>{
  const allSeedExams = [madridAdminTest, estadoConstitutionTest, madridAdminTest2, madridAdminTest2006, advoGeneralTest, advoGeneralTestMedium, advoGeneralTestHard, officeTest, madrid2023Test, madrid2025Test, madrid2017Test];
  if (!db) {
...
export async function loadInitialData() {
  try {
    ...
    const seedExams = [madridAdminTest, estadoConstitutionTest, madridAdminTest2, madridAdminTest2006, advoGeneralTest, advoGeneralTestMedium, advoGeneralTestHard, officeTest, madrid2023Test, madrid2025Test, madrid2017Test];
    const categoryCounts: { [key: string]: number } = {};
